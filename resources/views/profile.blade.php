...
<body class="bg-gradient-to-br from-gray-950 to-gray-900 min-h-screen flex flex-col items-center justify-center p-4">
    <main class="w-full max-w-6xl mx-auto flex flex-col items-center justify-center gap-12">
        <div class="max-w-full flex flex-wrap gap-6 justify-center"> <!-- FLEX CONTAINER -->
            ...
            <div class="profile-card cursor-pointer group">
                <div class="relative flex flex-col items-center">
                    <div id="addBtn"
                        class="relative w-32 h-32 rounded-xl overflow-hidden bg-gray-800 shadow-lg transition-all duration-300 group-hover:shadow-2xl flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-16 w-16 text-gray-400 group-hover:text-white transition-colors duration-300"
        ...
        <button
            class="mt-8 px-8 py-2 text-gray-400 hover:text-white border border-gray-700 rounded-md hover:bg-gray-800 transition-all duration-300">
            Manage Profiles
        </button>
    </main>
        ...
        <div class="bg-gray-900 rounded-lg p-8 max-w-md w-full mx-4">
            ...
            <form id="addProfileForm" class="space-y-6" action="{{ route('profile.create') }}" method="POST">
                ...
                <div class="flex justify-between">
                    <button type="button" id="cancelAddProfile"
                        class="px-4 py-2 bg-gray-800 text-gray-300 rounded hover:bg-gray-700 transition-colors duration-300">
                        Cancel
                    </button>
                    <button type="submit"
